...
public class SellerController {
	...
	public String getformSeller(Model model) {
		// String userid = request.getRemoteUser();
		// System.err.println("user id: " + userid);
		String userid = "user1";
		List<Store> store = svStoreService.findStoreByUserId(userid);
		System.err.println("store user id: " + store.get(0).getName());
		// List<Product> list = svStsoreService.findProductByStore(storeId);
